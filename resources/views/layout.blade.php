...
<html>
  <head>
    ...
    <script src="https://maps.google.com/maps/api/js?key=AIzaSyCh0c7Qd5PE6KkiO5TKpcyhNfR3nnwxdjQ&language=en"></script>
  ...
  <body>
    <header class="header">
      <div class="header__bar row">
        ...
        <img src="{{ asset('assets/images/nashio.png',config('app.asset-secure')) }}" width="70" height="100" alt="" class="disappear">
    </div>
    </header>
    @yield('content')
<hr>
